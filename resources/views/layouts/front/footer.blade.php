<footer class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-3 border-none bg-light p-5 d-flex flex-column justify-content-between me-3" >
                <div >
            ...
            <div class="row col-9 border-none bg-light p-5 d-flex flex-column h-100">
